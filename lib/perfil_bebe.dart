...
class _PerfilBebeState extends State<PerfilBebe> {
    ...
    Globals.actualizarPantalla = () {
      setState(() {
        Globals.pantallaActual =
            Recomendaciones(nombre: Globals.nombre_interpretador, id_bebe: widget.id_bebe);
  ...
  Color _colorT5 = Colors.black;
  Color _colorT6 = Colors.black;
  Widget _pantalla = Text("data");
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      setState(() {
                        ...
                        _colorBEdit = Colors.black;
                        _colorBEgraf = Colors.white;
                        _titulo = 'Interpretador de llantos';
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      setState(() {
                        ...
                        _colorBEdit = Colors.black;
                        _colorBEgraf = Colors.white;
                        _titulo = 'Registro de medicamentos';
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      _colorBEdit = Colors.black;
                      _colorBEgraf = Colors.white;
                      _titulo = 'Recomendacion de la interpretacion';
                      Globals.contador = '';
                      setState(() {
                        _pantalla = Recomendaciones(
                            nombre: Globals.nombre_interpretador, id_bebe: widget.id_bebe);
                      });
                    },
                    child: Container(
                      height: 45,
