...
class _InterpretadorState extends State<Interpretador> {
      ...
      result?.listen((event) {
        ...
        setState(() {
          ...
          if (Globals.nombre_interpretador == 'Dolor de Vientre' ||
            ...
            registrarDato(Globals.nombre_interpretador, soloFecha, Globals.idBebe);
          /*  if (_sound != 'Ruido')
           mostrarNotificacion(
  ...
  Future<void> registrarDato(
    ...
    final url = Uri.parse(
        '${Api.url}/api/v1/dato/registrar'); // Cambia la URL a la de tu API
